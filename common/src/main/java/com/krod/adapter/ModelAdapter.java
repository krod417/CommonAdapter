...
public class ModelAdapter extends BaseListAdapter<BaseViewHolder> {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        BaseViewHolder temp = getItem(i);
        if(view == null) {
            viewHolder = AdapterUtil.createItem(temp.getClass(), temp.content);
            view = viewHolder.onCreateView(context,viewGroup);
            view.setTag(viewHolder);
        } else {
            viewHolder = (BaseViewHolder)view.getTag();
        }
        viewHolder.bindData(i, temp);
        return view;
    }
     ...
     */
    @Override
    public void addList(List<? extends BaseViewHolder> list) {
        super.addList(list);
    ...
    public <T> void addList(Class<? extends BaseViewHolder> c, ArrayList<T> list) {
        addList(AdapterUtil.setList(c, list));
    }
    ...
    public <T> void addItem(Class<? extends BaseViewHolder> c, T t) {
        super.addItem(AdapterUtil.createItem(c, t));
    }
}
