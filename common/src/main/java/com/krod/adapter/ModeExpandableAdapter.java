...
public class ModeExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpand, View convertView, ViewGroup parent) {
        ...
        ExpandableHolder temp = getGroup(groupPosition);
        if (convertView == null) {
            holder = (ExpandableHolder) AdapterUtil.createItem(temp.getClass(), temp.content);
        ...
        holder.bindData(groupPosition, temp);
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ExpandableHolder holder;
        ExpandableHolder temp = getChild(groupPosition, childPosition);
        if (convertView == null) {
            holder = (ExpandableHolder) AdapterUtil.createItem(temp.getClass(), temp.content);
            convertView = holder.onCreateView(context, parent);
            holder.afterViewCreated();
        ...
        holder.bindData(childPosition, temp);
        return convertView;
    }
